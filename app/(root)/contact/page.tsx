          ...
          <div className="max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-12">
            ...
            <div className={`contact-form-enhanced ${isVisible ? 'fade-in-up delay-300' : 'opacity-0'}`}>
              ...
              <form className="space-y-6" action="https://formsubmit.co/kabirsahu725@gmail.com" method="POST">
                ...
                <div className="form-group">
                  <label htmlFor='phone' className='form-label-enhanced'>Phone Number (optional)</label>
                  <input 
                    type='tel' 
                    id='phone' 
                    name='phone'
                ...
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    <div className="social-links-enhanced">
                      <a href='https://www.linkedin.com/in/kabir-sahu-b7401b208/' target='_blank' rel='noopener noreferrer' className='social-link' title="LinkedIn">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                        </svg>
                      </a>
                      <a href='https://github.com/kabir325' target='_blank' rel='noopener noreferrer' className='social-link' title="GitHub">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a href='https://wa.me/917587109160' target='_blank' rel='noopener noreferrer' className='social-link' title="WhatsApp">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
